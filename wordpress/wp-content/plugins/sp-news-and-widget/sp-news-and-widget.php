...
if( ! defined( 'WPNW_VERSION' ) ) {
	define( 'WPNW_VERSION', '4.7.2' ); // Version of plugin
}
if( ! defined( 'WPNW_DIR' ) ) {
...
if( ! defined( 'WPNW_PLUGIN_LINK_UPGRADE' ) ) {
	define('WPNW_PLUGIN_LINK_UPGRADE','https://www.essentialplugin.com/pricing/?utm_source=WP&utm_medium=News&utm_campaign=Upgrade-PRO#wpos-epb'); // Plugin Check link
}
